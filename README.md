...
Este trabajo soluciona esa limitación técnica mediante un *web scraper* automatizado que visita cada ficha, extrae el RUT de la entidad legal correspondiente y consolida una base de datos apta para el análisis estadístico.
